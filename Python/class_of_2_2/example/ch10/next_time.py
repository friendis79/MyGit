...
rock_image = PhotoImage(file = "D:/Coding/Python/class_of_2_2/image/rock.png")
paper_image = PhotoImage(file = "D:/Coding/Python/class_of_2_2/image/paper.png")
scissors_image = PhotoImage(file = "D:/Coding/Python/class_of_2_2/image/scissors.png")
...
def decide(human) :
    ...
    if ((computer == "바위" and human == "보")
        ...
        counter += 1
        result = "인간 승리!" + "우승 횟수 :" + counter
        
    elif computer == human:
        result = "비겼습니다!" + "우승 횟수 :" + counter
    
    else :
        result = "컴퓨터 승리!" + "우승 횟수 :" + counter
