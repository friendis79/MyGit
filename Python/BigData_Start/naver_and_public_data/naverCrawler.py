...
def jsonFileWrite(jsonResult):
    ...
    with open("./saveNNaverCraw.json", "w", encoding="utf-8") as outfile :
...
def naverCrawler() :
    ...
    for i in searchT :
        urlV = uc.getNaverURLSetting(i, strV)     # URL Setting
        resD = uc.getURL(urlV, "naver")

        retData = json.loads(resD)
        ...
        sf.jsonFileWrite(resultD, "naver")
